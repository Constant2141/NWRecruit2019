        ...
        <div class="paper" v-if="IsShowPaper">
          ...
          <form class="form">
            ...
            <div class="form-box" @click="inf">
              ...
              <input type="text" id="major" placeholder="点击编辑" v-model="major" readonly>
            </div>
            <section class="inf" v-show ="IsShowInf">
              <div class="close2" @click="IsShowInf = false">&times;</div>
              <div class="form-box3">
                <label for="stuID" class="mgl50">學號</label>
                <input type="text" maxlength="12" id="stuID" placeholder="点击编辑" v-model="stuID" @blur="this.toTop">
              </div>
              <div class="form-box3">
              ...
              <div class="form-box3">
                ...
                <input type="text" maxlength="12" id="call" placeholder="点击编辑" v-model="call"  @blur="this.toTop">
              </div>
