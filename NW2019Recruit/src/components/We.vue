<template>
  <div class="we-container" :style="{height:clientHeight}">
    ...
    <div class="we-word" lang="ch" ref="weNW">
      ...
      <h1 id="font-bottom">
        <span>W</span>atch
      </h1>Night's Watch 工作室成立于2017年初，前身是协同工作室前端组，目前主要分为全栈，设计组，工作室专注设计并开发Web项目、移动端网页及小程序，特色独立项目为女生节的许愿墙。我们着重培养多方面、多技能的人才，提升自己的竞争力。守夜人工作室一直秉持<del>在玩耍中学习</del>理论与实践相结合的学习理念，在工作室培训中积累理论知识，在项目中增加实战经验。毕业的师兄大多就职于阿里、网易、腾讯等一线互联网公司。
    </div>
  </div>
</template>
